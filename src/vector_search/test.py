...
extractor = SimSiamFeatureExtractor(model_path="model/checkpoint_best.pth", backbone="resnet18", in_channels=1)
...
from src.vector_search import ImageIndexer
...
if os.path.exists(query_image_path):
    ...
    print("報告已儲存至 outputs/retrieval_vis/retrieval_top20.png")
